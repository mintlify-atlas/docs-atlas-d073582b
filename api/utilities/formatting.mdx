...
<Note>Available as an SDK instance method</Note>
...
<Tabs>
  ...
  <Tab title="With parseUnits">
    ```typescript
    import { parseUnits } from '@avail-project/nexus-core';
    
    // Manual method - must specify decimals
    const amount = parseUnits('100', 6);
    // Must know USDC has 6 decimals on Ethereum
    ```
  </Tab>
</Tabs>
